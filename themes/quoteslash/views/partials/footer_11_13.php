...
<?php if ($this->session->flashdata('quote_success')) { ?>
            ...
            var html = '<h2 class="reg-heading">Congratulations !</h2><p class="">Your quote request was submitted successfully.<br>We will get back to you with further updates shortly.<br><label class="thanks">Thanks,</label><br>Quoteslash Team</p>';
            $(".modal-body").html(html);
<?php } ?>
<?php if ($this->session->flashdata('binder_success')) { ?>
            $('#myModal').modal('show');
            $(".modal-title").html('Binder Request');
            var html = '<h2 class="reg-heading">Congratulations !</h2><p class="">Your binder request was submitted successfully.<br>We will get back to you with further updates shortly.<br><label class="thanks">Thanks,</label><br>Quoteslash Team</p>';
            $(".modal-body").html(html);
<?php } ?>
        //        sticky footer 
