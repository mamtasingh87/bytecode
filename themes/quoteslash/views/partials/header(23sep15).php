                ...
                <div id="container" class="container" >
                    <div class="row ">
                        <div class="display-table ">
                            ...
                            <div class="col-sm-3  display-table-cell"><a id="logo" href="{{ site_url }}"><img  src="{{ theme_url }}/assets/images/logo.png" alt="logo"/></a> </div>
                            <div class="col-sm-6 display-table-cell">
                                ...
                                <div class="mobile-menu">
                                    ...
                                    <ul class="mobile-nav">
                                        <li><a href="{{ site_url }}/home" title="Welcome">Welcome</a></li>
                                        <li><a href="{{ site_url }}/about" title="Welcome">About Us</a></li>
                                        <li><a href="{{ site_url }}/service" title="Welcome">Services</a></li>
                                        <li><a href="{{ site_url }}/started" title="Welcome">Get Started</a></li>
                                        <li><a href="{{ site_url }}/contact" title="Welcome">Contact Us</a></li>
                                    </ul>
                                </div>
                            </div>
