        ...
        <div class="col-sm-2">
            ...
            <div class="small-box <?php echo $class; ?>" title="Amount">
                <div class="inner">
                    ...
                    <span><?php echo (isset($redeemPoint[0]) && $redeemPoint[0])?$redeemPoint[0]:'';?> Redeem points ($<?php echo (isset($redeemPoint[1]) && $redeemPoint[1])?$redeemPoint[1]:'';?>)</span>
                </div>
            </div>
        </div>
        <div class="rdm-link">
            <div class="small-box <?php echo $class; ?>" title="Redeem points">
                <div class="inner">
                    <a href="<?php echo site_url('/redemption/redeem/showlist'); ?>">
                        <span>Redeem points <i class="fa fa-angle-right rdm"></i></span>
                    </a>
                </div>
            </div>
        </div>
