...
<div>                   <table>
                        <tr><td><?php echo form_label('Club:', 'club'); ?></td><td><?php echo form_label('Points Per Quote:', 'quote_point'); ?></td><td><?php echo form_label('Points Per Binder:', 'binder_point'); ?></td></tr>
