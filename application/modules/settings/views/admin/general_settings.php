...
<!--                   <div>
                   ...
                   <div>
                        <?php echo form_label('<span class="required">*</span>Send user on Icontact:', 'send_user_on_icontact'); ?>
                        <span>
                            <label><?php echo form_radio(array('name' => 'send_user_on_icontact', 'value' => '1', 'checked' => set_radio('send_user_on_icontact', '1', ( ! empty($Settings->send_user_on_icontact->value)) ? TRUE : FALSE))); ?> Yes</label>
                            <label><?php echo form_radio(array('name' => 'send_user_on_icontact', 'value' => '0', 'checked' => set_radio('send_user_on_icontact', '0', (empty($Settings->send_user_on_icontact->value)) ? TRUE : FALSE))); ?> No</label>
                        </span>
                    </div>
<!--                   <div>
                        <?php // echo form_label('<span class="required">*</span> Allow Points On Auto Registration:', 'allow_point_auto_registration'); ?>
...
<div>                   <table>
        <tr><td><?php echo form_label('Club:', 'club'); ?></td><td><?php echo form_label('Referrals In Trailing Months','referrals_trailing_months'); ?></td><td><?php echo form_label('Points Per Quote:', 'quote_point'); ?></td><td><?php echo form_label('Points Per Binder:', 'binder_point'); ?></td><td><?php echo form_label('Points Per Referrals','points_per_referrals'); ?></td></tr>
        <tr><td>Bronze</td><td><?php echo form_input(array('name' => 'bronze_no_referrals_trailing_months', 'id' => 'bronze_no_referrals_trailing_months', 'value' => set_value('bronze_no_referrals_trailing_months', isset($Settings->bronze_no_referrals_trailing_months->value) ? $Settings->bronze_no_referrals_trailing_months->value : ''))); ?></td><td><?php echo form_input(array('name' => 'bronze_club_quote_point', 'id' => 'bronze_club_quote_point', 'value' => set_value('bronze_club_quote_point', isset($Settings->bronze_club_quote_point->value) ? $Settings->bronze_club_quote_point->value : ''))); ?></td><td><?php echo form_input(array('name' => 'bronze_club_binder_point', 'id' => 'bronze_club_binder_point', 'value' => set_value('bronze_club_binder_point', isset($Settings->bronze_club_binder_point->value) ? $Settings->bronze_club_binder_point->value : ''))); ?></td><td><?php echo form_input(array('name' => 'bronze_points_per_referrals', 'id' => 'bronze_points_per_referrals', 'value' => set_value('bronze_points_per_referrals', isset($Settings->bronze_points_per_referrals->value) ? $Settings->bronze_points_per_referrals->value : ''))); ?></td></tr>
        <tr><td>Silver</td><td><?php echo form_input(array('name' => 'silver_no_referrals_trailing_months', 'id' => 'silver_no_referrals_trailing_months', 'value' => set_value('silver_no_referrals_trailing_months', isset($Settings->silver_no_referrals_trailing_months->value) ? $Settings->silver_no_referrals_trailing_months->value : ''))); ?></td><td><?php echo form_input(array('name' => 'silver_club_quote_point', 'id' => 'silver_club_quote_point', 'value' => set_value('silver_club_quote_point', isset($Settings->silver_club_quote_point->value) ? $Settings->silver_club_quote_point->value : ''))); ?></td><td><?php echo form_input(array('name' => 'silver_club_binder_point', 'id' => 'silver_club_binder_point', 'value' => set_value('silver_club_binder_point', isset($Settings->silver_club_binder_point->value) ? $Settings->silver_club_binder_point->value : ''))); ?></td><td><?php echo form_input(array('name' => 'silver_points_per_referrals', 'id' => 'silver_points_per_referrals', 'value' => set_value('silver_points_per_referrals', isset($Settings->silver_points_per_referrals->value) ? $Settings->silver_points_per_referrals->value : ''))); ?></td></tr>
        <tr><td>Gold</td><td><?php echo form_input(array('name' => 'gold_no_referrals_trailing_months', 'id' => 'gold_no_referrals_trailing_months', 'value' => set_value('gold_no_referrals_trailing_months', isset($Settings->gold_no_referrals_trailing_months->value) ? $Settings->gold_no_referrals_trailing_months->value : ''))); ?></td><td><?php echo form_input(array('name' => 'gold_club_quote_point', 'id' => 'gold_club_quote_point', 'value' => set_value('gold_club_quote_point', isset($Settings->gold_club_quote_point->value) ? $Settings->gold_club_quote_point->value : ''))); ?></td><td><?php echo form_input(array('name' => 'gold_club_binder_point', 'id' => 'gold_club_binder_point', 'value' => set_value('gold_club_binder_point', isset($Settings->gold_club_binder_point->value) ? $Settings->gold_club_binder_point->value : ''))); ?></td><td><?php echo form_input(array('name' => 'gold_points_per_referrals', 'id' => 'gold_points_per_referrals', 'value' => set_value('gold_points_per_referrals', isset($Settings->gold_points_per_referrals->value) ? $Settings->gold_points_per_referrals->value : ''))); ?></td></tr>
