                ...
                <table class="list">
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="status" >
                                <option value=''> Select Status </option>
                                <option value="0" <?php echo isset($params['status']) && $params['status'] === '0' ? 'selected="selected"' : ''; ?>>Pending</option>
                                <option value="1" <?php echo isset($params['status']) && $params['status'] === '1' ? 'selected="selected"' : ''; ?>>Approved</option>
                                <option value="2" <?php echo isset($params['status']) && $params['status'] === '2' ? 'selected="selected"' : ''; ?>>Disapproved</option>
                            </select> 
                        </td>
                        <td>
        ...
        <table class="list">
            ...
            <tbody>
                <?php if ($requestsdata): ?>
                    ...
                    <?php if($request->is_converted_binder==1) { $class="row_highlight"; } else {$class="";} ?>
                        <tr >
