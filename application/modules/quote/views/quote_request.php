...
<div class="get-started">
    <p>Complete the <strong>QUOTE SLASH</strong> template below, then click <strong>"Submit Request"</strong> at the bottom right corner of the template. Your data will be processed through our comparative rating software to determine the lowest quote available and have it delivered directly to the email address of your choice. Drag the "Quote Slash Quote Request" box (below) to your desktop and drop:</p>
    <p class="pra-bg">
        <a href="<?php echo site_url('/quote_request'); ?>">Quote Slash Quote Request</a>
    </p>    
...
<div class="quote-request-bottom">
    <fieldset>    
        ...
        <div class="content-box">
            ...
            <div class="content-box-in">
                ...
                <div class="row">
                        <div class="col-sm-6">
                            <div class="control-group form-group">
                                <label for="client_email" class="control-label">Email <span class="required">*</span></label>
                                <div class='controls'>
                                    <input id="client_email" class="form-control" type="text" name="client_email" maxlength="100" value="<?php echo set_value('client_email'); ?>"  />
                        ...
                        <div class="col-sm-6">
                            <div class="control-group form-group">
                                <label for="client_phone" class="control-label">Phone No <span class="required">*</span></label>
                                <div class='controls'>
                                    <input id="client_phone" class="form-control" type="text" name="client_phone" maxlength="25" value="<?php echo set_value('client_phone'); ?>"  />
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="control-group form-group">
                            ...
                            <div class='controls'>
                                <input id="client_dob" class="form-control datepicker_dob"  type="text" readonly="readonly" class="datepicker" name="client_dob" maxlength="100" value="<?php echo set_value('client_dob'); ?>"  />
        ...
        <div class="content-box">        
            ...
            <div class="content-box-in">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="control-group form-group">
                            ...
                            <div class='controls'>
                                <input class="datepicker form-control" type="text" name="effective_date"  value="<?php echo set_value('effective_date'); ?>"  readonly="readonly"/>
                ...
                <div class="control-group form-group">
                    ...
                    <label for="is_foreclosure" class="control-label checkbox-label">
                        Foreclosure
                    </label>
                ...
                <div class="control-group form-group">
                    ...
                    <label for="is_bankruptcy" class="control-label checkbox-label">
                        Bankruptcy
                    </label>
                ...
                <div class="control-group form-group">
                    ...
                    <label for="is_bank_owned" class="control-label checkbox-label">
                        Bank Owned
                    </label>
                ...
                <div class="control-group form-group">
                    <p class="form-text">If you have a wind mitigation, dec page, or inspection document, please upload here.</p>
                    <label for="request_document" class="control-label">Request Document</label>
                    <div class='controls'>
                        <div class="input_fields_wrap pull-left">
    
                        <input id="request_document"  type="file" multiple name="request_document[]" />
                        <!--<input id="request_document" type="file" multiple name="request_document[]" />-->
        ...
        <div class="control-group ">
            <!--        <label></label>-->
            <div class="controls text-left" style="text-align:right;">
...
$(document).ready(function() {
    ...
    $(add_button).click(function(e){ //on add input button click
        ...
        if(x < max_fields){ //max input box allowed
            ...
            $(wrapper).append('<input id="request_document"  type="file" multiple name="request_document[]" /></div>'); //add input box
        }
    });
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(".datepicker_dob").datepicker({
            ...
            changeYear: true,
            yearRange: '1915:2010',
            defaultDate: new Date('1 January 1915'),
            dateFormat: 'mm-dd-yy'
        });
    });
//            dateFormat: 'yy-mm-dd'
