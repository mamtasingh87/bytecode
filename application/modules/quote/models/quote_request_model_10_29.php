...
class Quote_request_model extends DataMapper {
    ...
    public function getAllStatus() {
        return array('' => 'Select Status', self::STATUS_RECIEVED => 'Recieved', self::STATUS_IN_PROGRESS => 'In Progress', self::STATUS_INFO_NEEDED => 'Additional Info Needed', self::STATUS_COMPLETED => 'Completed');
    }
