...
<FL val="Requestor First Name">'.$firstname.'</FL>
<FL val="Requestor Last Name">'.$lastname.'</FL>
<FL val="Requestor Phone">'.$phone_no.'</FL>
<FL val="Requestor Email">'.$email.'</FL>
</row>
</SalesOrders>';
...
//================= start curl ===================
            ...
            if (function_exists('curl_file_create')) {
                $content = new CurlFile(UPLOADPATH . 'files/binder_docs/' . $file);
            } else {
                $content = '@' . UPLOADPATH . 'files/binder_docs/' . $file;
            }
