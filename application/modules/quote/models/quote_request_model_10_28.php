...
class Quote_request_model extends DataMapper {
    ...
    public function getAllStatus() {
        return array('' => 'Select Status', self::STATUS_RECIEVED => 'Recieved', self::STATUS_IN_PROGRESS => 'In Progress', self::STATUS_INFO_NEEDED => 'Additional Information Needed', self::STATUS_COMPLETED => 'Completed');
    }
...
//        echo $this->db->last_query();exit;
    ...
    function SaveQuoteToZoho($form_data, $file = '') {
        ...
        $xmlData = '<Leads>      
<row no="2">
<FL val="First Name">' . $form_data['client_first_name'] . '</FL>
...
<FL val="Current Status">Recieved</FL>
</row>
</Leads>';
