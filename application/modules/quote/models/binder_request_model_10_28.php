...
class Binder_request_model extends DataMapper {
    ...
    public function getAllStatusForGrid() {
        return array(0 => 'Select Status', self::STATUS_APPROVED => 'In Progress', self::STATUS_DECLINE => 'Additional Info Needed' , self::STATUS_COMPLETE=>'Completed');
    }
...
<FL val="Current Status">Received</FL>
</row>
</SalesOrders>';
