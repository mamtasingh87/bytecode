...
<div class="box">
    ...
    <div class="content">
        <table class="list">
            ...
            <tr>
                <th>Ordered On</th>
                <td><?php echo isset($request_data['ordered_on']) ? date(DATE_TIME_FORMAT,  strtotime($request_data['ordered_on'])) : ''; ?></td>
            </tr>
<!--            <tr>
                <th>Shipping On</th>
                ...
                <tbody>
                    ...
                    <?php $status = ($o_data['status'] == 5 ? 'Processed' : ($o_data['status'] == 4 ? 'Cancelled' : ($o_data['status'] == 3 ? 'Delivered' : ($o_data['status'] == 2 ? 'Shipped' : 'Pending')))); ?>
                        <tr>
                            ...
                            <td><?php echo (strtotime($o_data['change_on'])>0)?date(DATE_TIME_FORMAT,  strtotime($o_data['change_on'])):'' ?></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
