...
<div class="content">
    <dl>
        ...
        <dt>Ordered On</dt>
        <dd><?php echo (isset($request_data['ordered_on']) && strtotime($request_data['ordered_on']) > 0) ? date('Y M,d', strtotime($request_data['ordered_on'])) : ''; ?></dd>
        <dt>Shipping On</dt>
        <dd><?php echo (isset($request_data['shipped_on']) && strtotime($request_data['shipped_on']) > 0) ? date('Y M,d', strtotime($request_data['shipped_on'])) : 'Not Shipped'; ?></dd>
        <!--        <dt>Notes</dt>
...
<div class="content table-responsive">
    <table class="table">
        <thead>
            <tr>
                <th>Image</th><th class="left">Name</th><th class="left">Sku</th><th class="left">Slug</th><th class="left">Price</th><th class="left">Quantity</th>
