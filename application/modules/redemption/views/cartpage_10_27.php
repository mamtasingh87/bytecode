...
<?php if (count($cart_items) > 0): ?>
    ...
    <div class="col-nest">
        ...
        <?php echo $image; ?>
                                        ...
                                        <td>
                                            ...
                                            <i style="display: none;" onclick="update_qty(this,<?php echo $cart_values['product_id'] ?>)" class="fa fa-check"></i>
                                        </td>
    ...
    <script type="text/javascript">
        ...
        function update_qty(obj, prodId) {
            ...
            if (order_qty >= 1 && order_qty != null && order_qty != '') {
                jQuery.ajax({
                    ...
                    data: {pid: prodId, oqty: order_qty},
