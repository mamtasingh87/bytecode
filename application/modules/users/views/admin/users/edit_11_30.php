            ...
            <div id="edit-user-tab">
                <div class="form">
                    <div class="field_spacing">
                        ...
                        <?php echo form_dropdown('group_id', option_array_value($Groups, 'id', 'name'), set_value('group_id', (isset($User->group_id)) ? $User->group_id : $this->settings->users_module->default_group), 'id="groups" class="long"'); ?>
                    </div>
