...
//        exit;
    ...
    function previous_quotes() {
        ...
        $data['quotes'] = $quotes
                ...
                ->group_end()
                ->order_by(($this->input->get('sort')) ? $this->input->get('sort') : 'client_first_name', ($this->input->get('order')) ? $this->input->get('order') : 'desc')
...
//        echo $this->db->last_query();exit;
    ...
    function previous_binders() {
        ...
        $data['binders'] = $binders
                ...
                ->group_end()
                ->order_by(($this->input->get('sort')) ? $this->input->get('sort') : 'borrower_name', ($this->input->get('order')) ? $this->input->get('order') : 'desc')
                ->get_paged($this->uri->segment(4), $per_page, TRUE);
